...
def send_event_result(request, rank, combination):
    ...
    if get_student:
        for index, i in enumerate(get_student, start=1):
            if not i.is_sent:
                ...
                combination = i.registration.combination.code
